...
get_data <- function(target_date, version_start, version_end, source = c("hhs", "chng"), timeout_seconds = 30) {
  if (source == "hhs") {
  ...
  data <- fetch(data, return_empty = TRUE, timeout_seconds = timeout_seconds)
