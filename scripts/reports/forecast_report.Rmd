...
ggplotly(the_plot, tooltip = "text", height = 9000, width = 2000) %>%
  apply_view_defaults(params$forecast_nhsn, params$truth_data_nhsn, params$forecast_date, quantiles = c(0.8)) %>%
...
ggplotly(the_plot, tooltip = "text", height = 9000, width = 2000) %>%
  apply_view_defaults(params$forecast_nhsn, params$truth_data_nhsn, params$forecast_date, quantiles = c(0.8, 0.95, 0.99)) %>%
  layout(hoverlabel = list(bgcolor = "white"))
```
...
ggplotly(the_plot, tooltip = "text", height = 9000, width = 2000) %>%
  apply_view_defaults(params$forecast_nssp, params$truth_data_nssp, params$forecast_date, quantiles = c(0.8)) %>%
  layout(hoverlabel = list(bgcolor = "white"))
```
...
ggplotly(the_plot, tooltip = "text", height = 9000, width = 2000) %>%
  apply_view_defaults(params$forecast_nssp, params$truth_data_nssp, params$forecast_date, quantiles = c(0.8, 0.95, 0.99)) %>%
  layout(hoverlabel = list(bgcolor = "white"))
```
