...
# This "averaging method" refers to whether each forecaster's score is averaged over its own individually-reported set of keys and horizons
# or if it's averaged over a common set. The main difference is PyRenew is tossed out because it reports too few horizons and we also stop
