...
flu_scores <- aws.s3::s3read_using(qs2::qs_read, object = "2024/flu_hosp_prod/objects/scores", bucket = "forecasting-team-data") %>%
...
flu_forecasts <- aws.s3::s3read_using(qs2::qs_read, object = "2024/flu_hosp_prod/objects/joined_forecasts_and_ensembles", bucket = "forecasting-team-data")
...
forecast_dates <- aws.s3::s3read_using(qs2::qs_read, object = "2024/flu_hosp_prod/objects/forecast_dates", bucket = "forecasting-team-data")
covid_scores <- aws.s3::s3read_using(qs2::qs_read, object = "2024/covid_hosp_prod/objects/scores", bucket = "forecasting-team-data") %>%
  mutate(forecaster = case_match(
           forecaster,
    "windowed_seasonal_extra_sources" ~ "windowed_seasonal_nssp",
    "ensemble_linclim_windowed_seasonal" ~ "retro_submission",
  ...
  mutate(our_forecaster = forecaster %in% our_forecasters)
covid_forecasts <- aws.s3::s3read_using(qs2::qs_read, object = "2024/covid_hosp_prod/objects/joined_forecasts_and_ensembles", bucket = "forecasting-team-data") %>% ungroup()
...
nhsn_archive_flu <- aws.s3::s3read_using(qs2::qs_read, object = "2024/flu_hosp_prod/objects/nhsn_archive_data", bucket = "forecasting-team-data")
...
nhsn_archive_covid <- aws.s3::s3read_using(qs2::qs_read, object = "2024/covid_hosp_prod/objects/nhsn_archive_data", bucket = "forecasting-team-data")
...
```{r computing_phase}
flu_archive <- aws.s3::s3read_using(qs2::qs_read, object = "2024/flu_hosp_prod/objects/nhsn_archive_data", bucket = "forecasting-team-data")
...
covid_archive <- aws.s3::s3read_using(qs2::qs_read, object = "2024/covid_hosp_prod/objects/nhsn_archive_data", bucket = "forecasting-team-data")
