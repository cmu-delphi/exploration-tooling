...
- `climate_linear` is the best model for flu
- `seasonal_nssp_latest` is not a quantile forecast, and is not included
...
::: {.notes}
These scores are rates rather than counts, and color gives population. The x-axis is log10.
:::
